if(!customElements.get('f-localization-form')){class LocalizationForm extends HTMLElement{constructor(){super();this.elements={input:this.querySelector('input[name="locale_code"], input[name="country_code"]'),button:this.querySelector('button'),panel:this.querySelector('.f\\:disclosure-list')};this.elements.panel.removeAttribute('hidden')
...
if((window.innerWidth-offsetButton)<220){this.elements.button?.nextElementSibling?.classList.add('f:disclosure-list__right')}}
