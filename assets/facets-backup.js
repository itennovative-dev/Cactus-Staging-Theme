        ...
        setTimeout(
          () => {
            ...
            if(typeof(sb_csp_enable) !=="undefined"){
              if(sb_csp_enable == "1"){
                try{
                  $("body").append("<style>.product-card__atc, .product-card__info .limoniapps-discountninja-productprice, .product-card__quickview{display:none}</style>");
                }catch(e){}
              }
            } 
            // SB Code
      ...
      if(typeof(sb_csp_enable) !=="undefined"){
        if(sb_csp_enable == "1"){
          try{
            ...
            setTimeout(function(){
              myAppJavaScript_csp($);
              $("body").append("<style>.product-card__atc, .product-card__info .limoniapps-discountninja-productprice, .product-card__quickview{display:flex}</style>");
            },2000);
          }catch(e){}
        }
      }
